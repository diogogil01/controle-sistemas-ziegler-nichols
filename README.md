...
* `Projeto_Controle_Sistemas_Dinamicos.ipynb`: notebook com o código do projeto;
* `Documentacao_Projeto.docx`: documentação do trabalho;
* `Link_Google_Colab.pdf`: arquivo com o link do Colab;
